...
const topbarIcon = const Color(0xFF454F63);
const backgroudColor = const Color(0xFFF4F6F6);

const textColorTitle = const Color(0xFF383E42);
...
const vyColorOrange = const Color(0xFFDF8200);
const vyColorYellow = const Color(0xFFFAE053);
const vyColorBlack = const Color(0xFF212721);
